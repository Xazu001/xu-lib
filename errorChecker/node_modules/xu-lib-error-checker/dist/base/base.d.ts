...
export type BaseThingToDoResult = string | null | "true" | "false";
export type ThingToDo = (v: any) => BaseThingToDoResult;
export type ThingsToDo = Record<string, ThingToDo>;
export type TypesFunction = StringFunction | NumberFunction | ObjectFunction | AnyFunction | ArrayFunction;
